...
from src.models.charbert.modeling.modeling_charbert import CharBertForMaskedLM
from src.models.charbert.modeling.modeling_roberta import RobertaForMaskedLM
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            # print("validation lm_loss: ", lm_loss)
            # print("validation adv_loss: ", outputs[1])
