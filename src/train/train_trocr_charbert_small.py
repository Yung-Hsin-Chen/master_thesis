...
# Training
def train_trocr_charbert_small(experiment_version: str, train_loader, val_loader, test_loader, device, freeze_mode, layers, data, model_name, text_file, fine_tuned=None):
    # Define model
    if fine_tuned:
